...
public:
	 ...
	 */
	bool addTTS(const char* text, const char* address, const char* CAcert);

	bool addTTS(const String& text, const char* address, const char* CAcert);
	...
	void prepareWAV(void (*playCallback)(TTSError error, CompositeAudioFileSource* source));
